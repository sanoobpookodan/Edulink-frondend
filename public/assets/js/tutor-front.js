  ...
  var t = {
      ...
      window.selectSearchField = (t) => {
        ...
        (() => {
          e.forEach((t) => {
            if (
              t &&
              !t.classList.contains("tutor-js-form-select") &&
              !t.hasAttribute("noDropdown") &&
              !t.classList.contains("no-tutor-dropdown")
            ) {
                  ...
                  e.onclick = (r) => {
                    ...
                    o.forEach((o, a) => {
                      if (o.value === r.target.dataset.key) {
                        var i;
                        (i = c.querySelector(".is-active")) === null ||
                        i === void 0
                          ? void 0
              ...
              if (s) {
                s.oninput = (t) => {
                  ...
                  if (0 == m(l)) {
                    var n = false;
                    a.querySelectorAll(".tutor-form-select-option").forEach(
                      (t) => {
        ...
        function o(t, e, r) {
          ...
          Array.from(t).forEach((t) => {
            o += '\n            <div class="tutor-form-select-option '
              ...
              .concat(
                tutor_esc_attr(t.value),
                '" class="tutor-nowrap-ellipsis" title="',
              )
              .concat(tutor_esc_attr(t.text), '">')
              .concat(
                tutor_esc_html(t.text),
                "</span>\n            </div>\n            ",
              );
          });
          var a = "";
        ...
        t(document).on(
          ...
          function (e) {
            ...
            if (n.trim().length === 0) {
              tutor_toast(
                __("Warning", "tutor"),
                __("Blank comment is not allowed.", "tutor"),
                "error",
              );
              return;
            }
    ...
    63023: function () {
      window.jQuery(document).ready((t) => {
         ...
         */ if (t(".tutor-quiz-wrap").length) {
          if (
            !t(".tutor-table-quiz-attempts").length &&
            !t(".tutor-quiz-attempt-details").length
          ) {
        ...
        if (e.length) {
          ...
          if (o.time_limit.time_limit_seconds > 0) {
            ...
            var i =
              new Date(
                (a = r.attempt_started_at) === null || a === void 0
                  ? void 0
                  : a.replaceAll("-", "/"),
              ).getTime() +
              o.time_limit.time_limit_seconds * 1e3;
            var s = new Date(
              (n = o.date_time_now) === null || n === void 0
                ? void 0
                : n.replaceAll("-", "/"),
            ).getTime();
            ...
            var c = setInterval(function () {
              ...
              if (a < 0) {
                ...
                if (
                  ...
                  t("button[name='quiz_answer_submit_btn']").prop(
                    "disabled",
                    true,
                  ); // add alert text
                  ...
                  t.ajax({
                    ...
                    success: function r(r) {
                      var o = t("#tutor-quiz-time-expire-wrapper").data(
                        "attempt-allowed",
                      );
                      var a = t("#tutor-quiz-time-expire-wrapper").data(
                        "attempt-remaining",
                      );
                      ...
                      if (a > 0) {
                        ...
                        if (
                          t(
                            "".concat(n, " .flash-info span:first-child"),
    ...
    90521: function () {
      window.jQuery(document).ready((t) => {
        ...
        function c(e) {
          ...
          t(".tutor-quiz-answer-single").removeClass(
            ...
            n.each(function () {
              ...
              if (i === "radio" || i === "checkbox") {
                ...
                if (s) {
                  ...
                  if (n.prop("checked")) {
                    n.closest(".tutor-quiz-answer-single").addClass(
                ...
                e.find(".tutor-quiz-explanation-wrapper").removeClass(
                  "tutor-d-none",
                );
              }
            });
          ...
          if (a.length > 0) {
            Object.values(a).forEach((e) => {
              if (
                ...
                e.classList.contains("tutor-dropzone")
              ) {
              ...
              if (d === "radio") {
                ...
                c.each(function (o, a) {
                  if (!t(a).val().trim().length) {
                    e.find(".answer-help-block").html(
                      '<p style="color: #dc3545">'.concat(
                        __("The answer for this question is required", "tutor"),
                        "</p>",
                      ),
                    );
                    r = false;
        ...
        t(document).on(
          ...
          function (r) {
            ...
            var a = parseInt(
              t(this).closest("[data-question_index]").data("question_index"),
            ...
            if (v) {
              ...
              if (p && p.length) {
                 ...
                 */ if (t(".tutor-quiz-questions-pagination").length) {
                  ...
                  t(
                    '.tutor-quiz-questions-pagination a[href="' + v + '"]',
                  ).addClass("active");
                } // Increase counter
                o.text(a + 1);
              }
         ...
         */ t(document).on(
          ...
          function (e) {
            var r = t(this);
            var o = r.val();
            var a = r.hasClass("question_type_short_answer")
            ...
            r.closest(".quiz-attempt-single-question")
        ...
        t(document).on("submit", "#tutor-answering-quiz", function (r) {
          ...
          if (
            _tutorobject.quiz_options.quiz_when_time_expires ===
              "auto_submit" &&
            t("#tutor-quiz-time-update").hasClass("tutor-quiz-time-expired")
          ) {
            l = true;
            v = true;
          }
        ...
        t(document).on("click", "a", function (e) {
          ...
          if (
            e.target.classList.contains("sidebar-ask-new-qna-btn") ||
            e.target.classList.contains("tutor-quiz-question-paginate-item")
          ) {
            return;
          }
            ...
            var o = {
              ...
              buttons: {
                keep: {
                  ...
                  callback: function e() {
                    var e =
                      t("form#tutor-answering-quiz").serialize() +
                      "&action=" +
                      "tutor_quiz_abandon";
                    t.ajax({
        ...
        /* Disable start quiz button  */ t("body").on(
          "submit",
              ...
              if (e.success) {
                ...
                tutor_toast(
                  ...
                  (a =
                    e === null || e === void 0
                      ? void 0
                      : (o = e.data) === null || o === void 0
                        ? void 0
                        : o.message) !== null && a !== void 0
                    ? a
    ...
    11602: function () {
       ...
       */ document.addEventListener("DOMContentLoaded", function () {
         ...
         * @since 2.2.4
         */ var e = jQuery(
          ".tutor-table-responsive .tutor-table .tutor-dropdown",
        );
        if (e.length) {
    ...
    35852: function (t, e, r) {
      ...
      window.jQuery(document).ready((t) => {
        var { __ } = wp.i18n;
        t('.tutor-settings-pass-field [name="confirm_new_password"]').on(
          "input",
          function () {
      ...
      window.jQuery(document).ready((t) => {
         ...
         */ var e = function e(e) {
          ...
          this.error_alert = function () {
            tutor_toast(
              __("Error", "tutor"),
              __("Maximum file size exceeded!", "tutor"),
              "error",
            ); // alert('Something Went Wrong.');
          };
          this.toggle_loader = function (t, r) {
            e.find("#tutor_photo_meta_area .loader-area").css(
              "display",
              r ? "block" : "none",
            );
          };
  ...
  (() => {
      ...
      if (p) {
        p.onclick = () => {
          ...
          if (t.length) {
            ...
            tutor_toast(
              __("Warning", "tutor"),
              __("Nothing was selected for bulk action.", "tutor"),
              "error",
            );
          ...
          a(function* () {
            ...
            try {
              ...
              if (i.ok) {
                ...
                if (
                  s.success ||
                  200 === (s === null || s === void 0 ? void 0 : s.status_code)
                ) {
                  location.reload();
                } else {
                  var {
    ...
    function s() {
      return a(function* () {
        try {
          var t = yield fetch(
            "".concat(_tutorobject.tutor_url, "/assets/json/countries.json"),
          );
          if (!t.ok) {
            throw new Error(
    ...
    window.jQuery(document).ready((t) => {
      ...
      var s = function () {
        ...
        e.find("[action-tutor-clear-filter]")
        ...
        if (p.length > 0) {
          ...
          if (t("#course_filter_exclude_ids").length) {
            u["tutor-course-filter-exclude-ids"] = JSON.parse(
              t("#course_filter_exclude_ids").val(),
            );
          }
        }
        ...
        if (g.length > 0) {
          ...
          if (t("#course_filter_post_ids").length) {
            u["tutor-course-filter-post-ids"] = JSON.parse(
              t("#course_filter_post_ids").val(),
            );
          }
        }
        t.ajax({
    ...
    document.addEventListener("DOMContentLoaded", (t) => {
      ...
      /* end of sidetab tab */ /* comment text-area focus arrow style */ var f =
        document.querySelectorAll(".tutor-comment-textarea textarea");
      if (f) {
        f.forEach((t) => {
      ...
      window.addEventListener(
        ...
        m,
      ); /* commenting */ // quiz drag n drop functionality
      ...
      function b(t) {
        ...
        if (e === "touchstart") {
          ...
          if (v) {
            ...
            if (
              h.classList.contains("tutor-dropzone") ||
              h.closest(".tutor-dropzone")
            ) {
      ...
      function E() {
        ...
        this.querySelector(".tutor-dragging-text-conent").classList.add(
          "tutor-color-black",
        );
        this.classList.remove("tutor-drop-over");
      ...
      function z() {
        ...
        if (C.files.length > i) {
          ...
          tutor_toast(
            __("Warning", "tutor"),
            __("Max ".concat(a, " file allowed to upload"), "tutor"),
            "error",
          );
          return;
        }
    ...
    window.jQuery(document).ready((t) => {
      ...
      t(document).on(
        ...
        function (e) {
          e.preventDefault();
          var r =
            t(this).data("login_url") ||
            t(this).closest(".tutor-course-entry-box-login").data("login_url");
          if (r) {
            window.location.assign(r);
          } else {
            t(".tutor-login-modal").addClass("tutor-is-active");
        ...
        if (t.length > 0 && wp.date) {
          ...
          t.forEach((t) => {
            try {
              ...
              if (!isNaN(r)) {
                t.textContent = wp.date.dateI18n(
                  a,
                  r,
      ...
      a(function* () {
        ...
        if (t) {
          ...
          t.addEventListener("change", (t) => {
            ...
            var a =
              (r = e.find((t) => t.name === o)) === null || r === void 0
                ? void 0
                : r.states;
            ...
            if (a && a.length > 0) {
              ...
              n.innerHTML = '<option value="">'.concat(
                __("N/A", "tutor"),
                "</option>",
              );
            }
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        a(function* () {
          ...
          if (r) {
            ...
            var a =
              ...
              document.body.classList.contains("single-course-bundle");
            try {
              r.setAttribute("disabled", "disabled");
              r.classList.add("is-loading");
              var i = yield n(o);
              ...
              if (s === 201) {
                ...
                var v = '<a data-cy="tutor-native-view-cart" href="'
                  .concat(
                    (l =
                      u === null || u === void 0 ? void 0 : u.cart_page_url) !==
                      null && l !== void 0
                      ? l
                      : "#",
                    '" class="tutor-btn tutor-btn-outline-primary ',
                  ...
                  .concat(
                    a ? "tutor-btn-lg tutor-btn-block" : "tutor-btn-md",
                    " ",
                  )
                  .concat(
                    !(u === null || u === void 0 ? void 0 : u.cart_page_url)
                      ? "tutor-cart-page-not-configured"
                      : "",
                    '">',
                  )
                ...
                var f = new CustomEvent("tutorAddToCartEvent", {
                  detail: {
                    cart_count:
                      u === null || u === void 0 ? void 0 : u.cart_count,
                  },
      ...
      document.addEventListener("click", (t) => {
        if (t.target.classList.contains("tutor-cart-page-not-configured")) {
          ...
          tutor_toast(
            __("Error!", "tutor"),
            __("Cart page is not configured.", "tutor"),
            "error",
          );
        }
      ...
      document.addEventListener("click", (t) => {
        if (t.target.classList.contains("tutor-checkout-page-not-configured")) {
          ...
          tutor_toast(
            __("Error!", "tutor"),
            __("Checkout page is not configured.", "tutor"),
            "error",
          );
        }
      });
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      if (e) {
         ...
         */ function u() {
          var t;
          var e =
            (t = document.querySelector("#checkout_data")) === null ||
            t === void 0
              ? void 0
              : t.value;
          return JSON.parse(e);
        ...
        document.addEventListener("click", (e) =>
          a(function* () {
            ...
            if (e.target.closest("#tutor-toggle-coupon-button")) {
              ...
              var _ =
                p === null || p === void 0 ? void 0 : p.querySelector("input");
            ...
            if (e.target.closest("#tutor-apply-coupon-button")) {
              ...
              if (w.length === 0) {
                tutor_toast(
                  __("Failed", "tutor"),
                  __("Please add a coupon code.", "tutor"),
                  "error",
                );
                return;
              }
            ...
            if (e.target.closest("#tutor-checkout-remove-coupon")) {
              ...
              document
                .querySelector("#tutor-checkout-remove-coupon")
              ...
              o.innerHTML =
                (z = u()) === null || z === void 0
                  ? void 0
                  : z.pay_now_btn_text;
              (T = document.getElementById("tutor-temp-payment-method")) ===
                null || T === void 0
                ? void 0
                : T.remove();
              g();
        ...
        document.addEventListener("keydown", (t) => {
          if (
            t.key === "Enter" &&
            t.target.closest("input[name=coupon_code]")
          ) {
            t.preventDefault();
        ...
        d === null || d === void 0
          ...
          : d.addEventListener("submit", function (t) {
              ...
              if (e.payment_method_required && !r.get("payment_method")) {
                tutor_toast(
                  __("Error", "tutor"),
                  __("Please select a payment method.", "tutor"),
                  "error",
                );
                return;
              }
        ...
        var p =
          '<span class="tutor-btn is-loading tutor-checkout-spinner"></span>';
        function _(t) {
          return a(function* () {
            t.set(
              window.tutor_get_nonce_data(true).key,
        ...
        var h = (t, e) => {
          if ("show" === e) {
            ...
            t === null || t === void 0
              ? void 0
              : (r = t.closest(".tutor-position-relative")) === null ||
                  r === void 0
                ? void 0
            ...
            t === null || t === void 0
              ? void 0
              : (a = t.closest(".tutor-position-relative")) === null ||
                  a === void 0
                ? void 0
                : (o = a.querySelector(".tutor-checkout-spinner")) === null ||
                    o === void 0
                  ? void 0
                  : o.remove();
          }
        ...
        f === null || f === void 0
          ...
          : f.addEventListener("change", (t) =>
              a(function* () {
                ...
                var r = t.target.value;
                var o = (e === null || e === void 0 ? void 0 : e.value)
                  ? e.value
                  : "";
                if (r) {
                  h(t.target, "show");
        ...
        m === null || m === void 0
          ...
          : m.addEventListener("change", (t) =>
              a(function* () {
                ...
                var r = f.value;
                var o = t.target.value;
                var a = (e === null || e === void 0 ? void 0 : e.value)
                  ? e.value
                  : "";
                if (o) {
                  h(t.target, "show");
         ...
         */ function g() {
          ...
          if (i.length === 1) {
            ...
            if (e) {
              document
                .querySelector(".tutor-payment-instructions")
                .classList.remove("tutor-d-none");
              document.querySelector(".tutor-payment-instructions").innerHTML =
                e.innerHTML;
            }
          }
        }
     ...
     */ readyState_complete(() => {
      Object.entries(document.getElementsByTagName("a")).forEach((t) => {
        ...
        if (
          (e === null || e === void 0 ? void 0 : e.includes("/logout")) ||
          (e === null || e === void 0 ? void 0 : e.includes("logout"))
        ) {
    ...
    jQuery(document).ready(function (t) {
       ...
       */ var i = {
        ...
        track_player: function r() {
          ...
          if (typeof Plyr !== "undefined") {
            ...
            var n = new Plyr(this.player_DOM, {
              keyboard: {
                focused: r.isRequiredPercentage() ? false : true,
                global: false,
              },
              listeners: e(
                {},
                r.isRequiredPercentage() && {
                  seek(t) {
                    ...
                    if (e > a) {
                      ...
                      tutor_toast(
                        __("Warning", "tutor"),
                        __("Forward seeking is disabled", "tutor"),
                        "error",
                      );
                      return false;
                    }
            ...
            n.on("play", (e) => {
              ...
              if (_tutorobject.tutor_pro_url && n.provider === "youtube") {
                t(".plyr--youtube.plyr__poster-enabled .plyr__poster").css(
                  "opacity",
                  0,
                );
              }
        ...
        sync_time: function e(e, r) {
          ...
          var i =
            o.best_watch_time > e.currentTime
              ? o.best_watch_time
              : e.currentTime;
        ...
        disable_complete_lesson_btn: function e() {
          ...
          if (i < a) {
            ...
            s.after(
              /* translators: %s is the required watch percentage (e.g., 80) */ '<span class="tooltip-txt tooltip-bottom">'.concat(
                n(
                  __("Watch at least %s%% to complete the lesson.", "tutor"),
                  e.required_percentage,
                ),
                "</span>",
              ),
            );
       ...
       * @since v.1.6.9
       */ t(".tutor-course-title h4 .toggle-information-icon").on(
        "click",
        function (e) {
          t(this)
      ...
      t(".tutor-course-topic.tutor-active")
      ...
      t(document).on(
        ...
        function (e) {
          e.preventDefault();
          t(".tutor-course-single-content-wrapper").toggleClass(
            "tutor-course-single-sidebar-hidden",
          );
        },
      );
      t("[tutor-course-topics-sidebar-offcanvas-toggler]").on(
        "click",
        function (e) {
          e.preventDefault();
          t(".tutor-course-single-content-wrapper").toggleClass(
      ...
      t("[tutor-hide-course-single-sidebar]").on("click", function (e) {
        e.preventDefault();
        console.log("Hello");
        t(".tutor-course-single-content-wrapper").removeClass(
          "tutor-course-single-sidebar-open",
        );
            ...
            success: function e(e) {
              ...
              if (e.success) {
                ...
                if (e.data.available_balance !== "undefined") {
                  t(".withdraw-balance-col .available_balance").html(
      ...
      t(document).on("change", "#tutor_profile_photo_file", function (e) {
        ...
        if (r.files && r.files[0]) {
          var o = new FileReader();
          o.onload = function (e) {
            t(".tutor-profile-photo-upload-wrap")
              .find("img")
      ...
      t(document).on("click", "a.tutor_bp_plus_courses", function (e) {
        e.preventDefault();
        var r = t(this);
        r.closest(".tutor-bp-enrolled-courses-wrap")
      ...
      jQuery('#tutor-registration-form [name="password_confirmation"]').on(
        "input",
        function () {
